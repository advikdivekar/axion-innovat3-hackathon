...
export default function HomePage() {
  return (
    <>
      ...
      ══════════════════════════════════════════════════════════════════ */}
      <section className="bg-dark dot-grid" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', padding: '12rem 0 8rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6.4rem', flexWrap: 'wrap' }}>
            ...
            <motion.div variants={stagger} initial="hidden" animate="visible" style={{ flex: '1 1 46rem', minWidth: '30rem' }}>
              ...
              <motion.h1 variants={fadeUp} style={{
                ...
                marginBottom: '2.4rem', fontFamily: 'Inter, sans-serif',
              }}>
      ...
      ══════════════════════════════════════════════════════════════════ */}
      <section className="bg-dark dot-grid" style={{ padding: '9.6rem 0' }}>
        <div className="container">
          <div style={{ display: 'flex', gap: '6.4rem', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <motion.div variants={slideRight} initial="hidden" whileInView="visible" viewport={viewport} style={{ flex: '1 1 36rem' }}>
              ...
              <Link href="/app" className="btn btn-neon">
                Enter the Universe <ArrowRight size={16} />
              </Link>
            </motion.div>
          </div>
        </div>
      ...
      ══════════════════════════════════════════════════════════════════ */}
      <section className="bg-dark" style={{ padding: '12rem 0', position: 'relative', overflow: 'hidden' }}>
        {/* Glow sphere */}
        <div style={{
